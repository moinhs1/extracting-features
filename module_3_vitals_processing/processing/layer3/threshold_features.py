...
def calculate_threshold_features_patient(patient_df: pd.DataFrame) -> pd.DataFrame:
    """Calculate threshold-based features for a single patient.
...
def calculate_threshold_features(df: pd.DataFrame) -> pd.DataFrame:
    """Calculate threshold-based features (batch mode).

    For parallel processing, use calculate_threshold_features_patient instead.
    """
